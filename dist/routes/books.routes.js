...
router.get("/AvailableBooksWithAuthorName", books_controller_1.getAvailableBooksWithAuthorName); // get libros con state = true
...
router.get("/filterAvailableBooksByName/:name", books_controller_1.filterAvailableBooksByName); // get libros con state = true
